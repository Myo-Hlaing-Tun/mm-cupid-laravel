...
<body>
	<div class="error-page-wrap">
		<article class="error-page gradient">
			<hgroup>
				<h1>403</h1>
				<h2>oops! you are not allowed to access this route.</h2>
			</hgroup>
			<a href="{{url()->previous()}}" onclick="window.history.back(); return false;" title="Back to site" class="error-back">back</a>
		</article>
	</div>
</body>
</html>